...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_interaction p_interaction;
        ...
        public static SteamVR_Input_ActionSet_interaction interaction
        {
            get
            {
                return SteamVR_Actions.p_interaction.GetCopy<SteamVR_Input_ActionSet_interaction>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_interaction = ((SteamVR_Input_ActionSet_interaction)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_interaction>("/actions/interaction")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.interaction};
        }
    }
}
